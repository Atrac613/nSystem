          ...
          <TR>
            ...
            <TABLE class="TABLE_2">
			  ...
			  ?>
                <TR>
                  <TD><BR><BR><BR>
                  <FORM method=post enctype=multipart/form-data action='../login.php'><?php
				  if(!$uid){
				  	$name = "name";
					$pass = "pass";
                  ...
                  <TABLE border="0" width="100%" cellpadding="2" cellspacing="1" class="forumline">
                    <TBODY>
                      <TR class="table_title">
                        <TH colspan="2" align="center" height="25" valign="middle" nowrap>フォーラム</TH>
                        <TH align="center" valign="middle" width="86" nowrap>トピック</TH>
                        <TH width="50" align="center" valign="middle" nowrap>記事</TH>
