...
if($f_chk == 1){
	...
	sub_msg("3","forum/forum.php","フォーラムを削除しました!!","リロードします。");
}
            ...
            <TABLE width="100%" cellpadding="0" cellspacing="0">
              <TBODY>
                ...
                <TR>
				  ...
				  下記のフォーラム内のデータをすべて削除します。<BR><BR>
				  <?php
				  
				  echo "削除対象フォーラム：&nbsp;<B>$forum_name</B>";
				  
				  ?>
				  <BR><BR>
				  よろしいですか?<BR><BR>
				  <A href='delete_forum.php?f=<?php echo "$f"; ?>&chk=1'>はい</A>　/　<A href='forum_reg.php'>いいえ</A>
				  <BR><BR><BR>
				  </TD>
                </TR>
                <TR>
