          ...
          <TR>
            ...
            <TABLE width="100%" cellpadding="0" cellspacing="0">
              <TBODY>
                ...
                <TR>
                  <TD colspan="2" width="422" valign="top"><BR>NEWS<BR><BR>
				  
				  
				  <?php
				  	$news_id = $_GET["id"];
					$sql = "select * from `PHP_I-N` where `id` = '$news_id' and `i-n` = '1'";
					$result = $db->query($sql);
					$chk = $result->numRows();
					if($chk){
						$user_rows = $result->fetchRow(DB_FETCHMODE_ASSOC);
							...
							echo "<table border='0' width='400' cellpadding='1' cellspacing='1'><tr><td align=right>投稿日：$date</td></tr><tr><td class='color3'>";
							echo "&nbsp;<B>$title</B></td></tr></table><BR><blockquote> ";
							echo "$body";
							echo "</blockquote><BR><HR width='420'><A href='javascript:history.back()'>戻る</A><P></P>";
					}else{
						echo "&nbsp;&nbsp;&nbsp;・Newsはありません。<BR><BR><A href='javascript:history.back()'>戻る</A>";
					}
